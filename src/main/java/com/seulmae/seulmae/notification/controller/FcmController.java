...
import com.seulmae.seulmae.notification.service.FcmService;
...
public class FcmController {
    ...
    public ResponseEntity<?> pushMessage(@RequestBody @Validated FcmSendRequest fcmSendRequest) throws IOException {
        ...
        fcmService.sendMessageTo(fcmSendRequest.getFcmToken(), fcmSendRequest.getTitle(), fcmSendRequest.getBody());
